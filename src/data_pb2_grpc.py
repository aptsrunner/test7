...
class DataServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SaveData = channel.unary_unary(
                ...
                request_serializer=data__pb2.SaveDataRequest.SerializeToString,
                response_deserializer=data__pb2.SaveDataResponse.FromString,
...
def add_DataServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SaveData': grpc.unary_unary_rpc_method_handler(
                    servicer.SaveData,
                    request_deserializer=data__pb2.SaveDataRequest.FromString,
                    response_serializer=data__pb2.SaveDataResponse.SerializeToString,
            ),
...
class DataService(object):
    ...
    def SaveData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/data.DataService/SaveData',
            data__pb2.SaveDataRequest.SerializeToString,
            data__pb2.SaveDataResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
